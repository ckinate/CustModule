...
(function() {
    var lastTime = 0;
    var customers = ['webkit', 'moz'];
    for (var x = 0; x < customers.length && !window.requestAnimationFrame; ++x) {
        window.requestAnimationFrame = window[customers[x] + 'RequestAnimationFrame'];
        window.cancelAnimationFrame =
            window[customers[x] + 'CancelAnimationFrame'] || window[customers[x] + 'CancelRequestAnimationFrame'];
    }
...
var KTUtil = function() {
    ...
    return {
        ...
        animateDelay: function(el, value) {
            var customers = ['webkit-', 'moz-', 'ms-', 'o-', ''];
            for (var i = 0; i < customers.length; i++) {
                KTUtil.css(el, customers[i] + 'animation-delay', value);
            }
        },
        ...
        animateDuration: function(el, value) {
            var customers = ['webkit-', 'moz-', 'ms-', 'o-', ''];
            for (var i = 0; i < customers.length; i++) {
                KTUtil.css(el, customers[i] + 'animation-duration', value);
            }
        },
