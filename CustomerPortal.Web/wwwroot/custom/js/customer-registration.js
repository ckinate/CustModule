...
var KTCreateAccount = function () {
	...
	var initForm = function (element) {
		...
		var incorporationDate = $(form.querySelector('[name="incorporation_date"]'));
		incorporationDate.flatpickr({
			enableTime: false,
			dateFormat: "d, M Y",
		});

		var issueDate = $(form.querySelector('[name="issue_date"]'));
		issueDate.flatpickr({
			enableTime: false,
			dateFormat: "d, M Y",
		});

		var expiryDate = $(form.querySelector('[name="expiry_date"]'));
		expiryDate.flatpickr({
			enableTime: false,
			dateFormat: "d, M Y",
		});

		$('#contact_repeater').repeater({
			initEmpty: false,
